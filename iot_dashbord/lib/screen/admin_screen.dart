...
import 'package:iot_dashboard/component/admin/input_iot_register_section.dart';
...
//현장 정보 변수
  ...
  final _iotRestigerRidController = TextEditingController();
  final _iotRegisterLabelController = TextEditingController();
  final _iotRegisterSensorTypeController = TextEditingController();
  final _iotRegisterEventTypeController = TextEditingController();
  final _iotRegisterLocationController = TextEditingController();
  final _iotRegisterLatitudeController = TextEditingController();
  final _iotRegisterLongitudeController = TextEditingController();
                            ...
                            child: Center(
                              child: Column(
                                children: [
                                  ...
                                  InputIotRegisterSection(
                                      // iotRegisterRidController =
                                      //     _iotRestigerRidController,
                                      // iotRegisterLabelController =
                                      //     _iotRegisterLabelController,
                                      // iotRegisterSensorTypeController =
                                      //     _iotRegisterSensorTypeController,
                                      // iotRegisterEventTypeController =
                                      //  _iotRegisterEventTypeController,
                                      // iotRegisterLocationController =
                                      //     _iotRegisterLocationController,
                                      // iotRegisterLatitudeController =
                                      //     _iotRegisterLatitudeController,
                                      // iotRegisterLongitudeController =
                                      //     _iotRegisterLongitudeController),
                                  ),
