          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (firstSelected != null && date == firstSelected) {
                  bgColor = Colors.lightGreen; // ✅ 선택된 날짜 배경
                }

                if (DateUtils.isSameDay(today, date)) {
                  bgColor = Colors.grey; // ✅ 오늘 날짜 배경 (선택된 날짜보다 우선)
                }
                ...
                return InkWell(
                  onTap: () {
                    ...
                    // 부모로 값 전달하고 닫기
                    Navigator.of(context).pop(firstSelected);
                  },
